"""Unified v0.2.4 release-readiness checks with clear process exit status."""
...
EXPECTED_VERSION: Final[str] = "0.2.4"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="工程知识库 v0.2.4 统一发布检查")
