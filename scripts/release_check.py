"""Unified v0.5.0 release-readiness checks with clear process exit status."""
...
EXPECTED_VERSION: Final[str] = "0.5.0"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="工程知识库 v0.5.0 统一发布检查")
